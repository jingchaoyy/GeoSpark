...
import edu.gmu.stc.vector.rdd.{GeometryRDD_Header, ShapeFileMetaRDD}
...
/**
  * Created by Fei Hu.
  */
object STC_OverlapTest_v3_Header extends Logging{
...
//    val headers = GeometryReaderUtil_Header.getDbfHeader("/Users/YJccccc/GeoSpark/data/Washington_DC/Impervious_Surface_2015/Impervious_Surface_2015.dbf")
//    val headers1 = GeometryReaderUtil_Header.getDbfHeader("/Users/YJccccc/GeoSpark/data/Washington_DC/Impervious_Surface_2015/Impervious_Surface_2015.dbf")
//    print(headers)
    ...
    val shapeFileMeta1 = shapeFileMetaRDD1.getShapeFileMetaRDD.first()
    val bdfFilePath1 = shapeFileMeta1.getFilePath + GeometryReaderUtil_Header.DBF_SUFFIX
    val header1 = GeometryReaderUtil_Header.getDbfHeader(bdfFilePath1)

    val geometryRDD1 = new GeometryRDD_Header
    ...
    val shapeFileMeta2 = shapeFileMetaRDD2.getShapeFileMetaRDD.first()
...
//    print("$$$$$$$$$$$$$$$$$$$$$", header)
    ...
    if (filePath.endsWith("shp")) {
      geometryRDD.saveAsShapefile(filePath, crs, header)
    } else {
